/// Returns items whose key from `iteratee` has appeared before.
/// Each occurrence after the first is included.
///
/// # Arguments
/// * `collection` - Items to inspect.
/// * `iteratee` - Function returning the duplicate-detection key.
///
/// # Returns
/// * `Vec<T>` - Duplicate items after their first keyed occurrence.
///
/// # Examples
/// ```rust
