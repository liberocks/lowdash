/// Returns items whose key from `iteratee` appears exactly once, in input order.
///
/// # Arguments
/// * `collection` - Items to inspect.
/// * `iteratee` - Function returning the uniqueness key.
///
/// # Returns
/// * `Vec<T>` - Items with a unique generated key.
///
/// # Examples
/// ```rust
