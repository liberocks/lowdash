...
pub use combination_count::combination_count;
pub use compact::compact;
pub use contains_all::contains_all;
pub use contains_any::contains_any;
pub use contains_none::contains_none;
...
pub use elements_match::elements_match;
pub use elements_match_by::elements_match_by;
pub use ellipsis::ellipsis;
pub use entries::entries;
pub use entries::Entry;
pub use euclidean_distance::euclidean_distance;
pub use euclidean_norm::euclidean_norm;
pub use every::every;
...
pub use floating_sum::floating_sum;
...
pub use greatest_common_divisor::greatest_common_divisor;
pub use group_by::group_by;
pub use group_by_map::group_by_map;
pub use harmonic_mean::harmonic_mean;
pub use has_key::has_key;
pub use index_of::index_of;
pub use integer_square_root::integer_square_root;
...
pub use is_close::is_close;
pub use is_sorted::is_sorted;
pub use is_sorted_by_key::is_sorted_by_key;
pub use is_uniq::is_uniq;
pub use is_uniq_by::is_uniq_by;
pub use kebab_case::kebab_case;
pub use kernel_density_estimate::kernel_density_estimate;
pub use kernel_density_sample::kernel_density_sample;
...
pub use permutation_count::permutation_count;
...
pub use product_with_start::product_with_start;
...
pub use sum_products::sum_products;
...
pub use trim::trim;
pub use trim_end::trim_end;
pub use trim_start::trim_start;
pub use union::union;
pub use union_by::union_by;
pub use uniq::uniq;
pub use uniq_by::uniq_by;
pub use uniq_keys::uniq_keys;
pub use uniq_map::uniq_map;
